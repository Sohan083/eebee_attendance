package com.example.eebee_attendance.attendance
...
import com.example.eebee_attendance.MainActivity.Companion.presentAcc
            ...
            takePictureIntent.resolveActivity(requireActivity().packageManager)?.also {
                ...
                photoFile?.also {
                    val photoURI: Uri = FileProvider.getUriForFile(
                        requireContext(),
                        "com.example.eebee_attendance.fileprovider",
                        it
                    )
